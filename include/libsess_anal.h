...
#define WRITE_SMOOTHED_MAPS_DFLT		TRUE
#define WRITE_MAPS_DFLT				TRUE
#define WRITE_WCP_POSITION_DFLT			TRUE
#define WRITE_TS_DFLT				TRUE
...
#define POSITION_SAMPLING_FREQUENCY     50.0    /* in Hz, 50.0 for Europe, 60.0 for U.S. - used only for getting data from KM files */
