...
void	BackColor(S_I_4 color, FILE *fp)
{
	S_I_2	temp_si2;
...
void	DrawString(S_I_1 *s, FILE *fp)
{
	extern POINT	curPos;
	S_I_2		len, temp_si2;
	S_I_1		*c;
...
void	EraseArc(RECT *rect, S_I_2 startAngle, S_I_2 arcAngle, FILE *fp)
{
	S_I_2	temp_si2;
...
void	EraseRoundRect(RECT *rect, S_I_2 width, S_I_2 height, FILE *fp)
{
	S_I_2	temp_si2;
	POINT	point;
...
void	FillArc(RECT *rect, S_I_2 startAngle, S_I_2 arcAngle, FILE *fp)
{
	S_I_2	temp_si2;
...
void	FillOval(RECT *rect, FILE *fp)
{
	S_I_2	temp_si2;
...
void	FillPoly(POLYGON *polygon, FILE *fp)
{	
	S_I_2	temp_si2;
...
void	FillRect(RECT *rect, FILE *fp)
{
	S_I_2	temp_si2;
...
void	FillRoundRect(RECT *rect, S_I_2 width, S_I_2 height, FILE *fp)
{
	S_I_2	temp_si2;
	POINT	point;
...
void	ForeColor(S_I_4 color, FILE *fp)
{
	S_I_2	temp_si2;
...
void	FrameArc(RECT *rect, S_I_2 startAngle, S_I_2 arcAngle, FILE *fp)
{
	S_I_2	temp_si2;
...
void	FrameRoundRect(RECT *rect, S_I_2 width, S_I_2 height, FILE *fp)
{
	S_I_2	temp_si2;
	POINT	point;
...
void	InvertArc(RECT *rect, S_I_2 startAngle, S_I_2 arcAngle, FILE *fp)
{
	S_I_2	temp_si2;
...
void	InvertRoundRect(RECT *rect, S_I_2 width, S_I_2 height, FILE *fp)
{
	S_I_2	temp_si2;
	POINT	point;
...
void	Line(S_I_2 dh, S_I_2 dv, FILE *fp)
{
	extern POINT	curPos;
	S_I_2		temp_si2;
...
void	LineTo(S_I_2 h, S_I_2 v, FILE *fp)
{
	extern POINT	curPos;
	S_I_2		temp_si2;
...
void	GetIndPattern(S_I_2 index, PATTERN pattern)
{
...
FILE *OpenCPicture(S_I_1 *fname, S_F_4 native_h_dpi, S_F_4 native_v_dpi, S_I_2 native_h_dots, S_I_2 native_v_dots)
{
	extern POINT	curPos;
...
FILE *OpenPicture(S_I_1 *fname, S_I_2 width, S_I_2 height)
{
	extern POINT	curPos;
	RECT		srcRect;
	FILE		*fp;
...
void	PaintArc(RECT *rect, S_I_2 startAngle, S_I_2 arcAngle, FILE *fp)
{
	S_I_2	temp_si2;
...
void	PaintRoundRect(RECT *rect, S_I_2 width, S_I_2 height, FILE *fp)
{
	S_I_2	temp_si2;
	POINT	point;
...
void	PenMode(S_I_2 mode, FILE *fp)
{
	S_I_2	temp_si2;
...
void	PenSize(S_I_2 h, S_I_2 v, FILE *fp)
{
	S_I_2	temp_si2;
	POINT	point;
...
void	TextFace(U_I_1 face, FILE *fp)
{
	S_I_2	temp_si2;
...
void	TextFont(S_I_2 fontNum, FILE *fp)
{	
	S_I_2		temp_si2;
...
void	TextMode(S_I_2 mode, FILE *fp)
{	
	S_I_2	temp_si2;
...
void	TextScale(S_I_2 h_num, S_I_2 v_num, S_I_2 h_denom, S_I_2 v_denom, FILE *fp)
{
	S_I_2	temp_si2;
	POINT	point;
...
void	TextSize(S_I_2 size, FILE *fp)
{
	S_I_2	temp_si2;
...
void	FloatToFixed(S_F_4 num, FIXED *fixed)
{
	S_I_4	l;	
...
void	InsetPoly(POLYGON *polygon, S_I_2 dh, S_I_2 dv)
{
	S_I_2	i;
...
void	InsetRect(RECT *rect, S_I_2 dh, S_I_2 dv)
{
...
void	OffsetPoly(POLYGON *polygon, S_I_2 dh, S_I_2 dv)
{
	S_I_2	i;
...
void	OffsetRect(RECT *rect, S_I_2 dh, S_I_2 dv)
{
	rect->left += dh;
	rect->top += dv;
	rect->right += dh;
...
void	SetPattern(PATTERN pattern, S_I_1 *s)
{
	S_I_2	i;
...
void	SetPoint(POINT *point, S_I_2 h, S_I_2 v)
{
	point->h = h;
	point->v = v;
...
void	SetPoly(POLYGON *polygon, S_I_2 n_points, ...)
{
	va_list		ap;
	S_I_2		i, v, h;
...
void	SetRect(RECT *rect, S_I_2 left, S_I_2 top, S_I_2 right, S_I_2 bottom)
{
	rect->left = left;
	rect->top = top;
	rect->right = right;
...
void	SetRGBCol(RGBCOLOR *color, S_I_2 red, S_I_2 grn, S_I_2 blu)
{
	color->red = red;
	color->grn = grn;
	color->blu = blu;
...
void	UPWrite(void *data, size_t size, size_t n, FILE *fp)
{

#if defined(BIG_ENDIAN_MACHINE)

	(void) fwrite(data, size, n, fp);
	...
	for (i = n; i--;) {	
		...
		b = a;
		for (j = size; j--;)
			(void) fwrite((void *) (--b), sizeof(U_I_1), (size_t) 1, fp);
	}
